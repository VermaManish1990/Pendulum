...
public class VerifyOTPForgotPasswordActivity  extends BaseActivity implements View.OnClickListener, TextWatcher {
    private final String TAG = VerifyCodeActivity.class.getSimpleName();
    private String mCode,mPhone,mDetails;
    ...
    protected void initUI() {
        ...
        mEtCode.addTextChangedListener(VerifyOTPForgotPasswordActivity.this);
    ...
    public void updateUi(final boolean status, final int actionID, final Object serviceResponse) {
        ...
        switch (actionID) {
            case IApiEvent.REQUEST_FORGOT_PASSWORD_VERIFY_OTP:
                if (status) {
                    ...
                    if (verifyCodeResponseModel != null && verifyCodeResponseModel.status) {
                        ...
                        if (verifyCodeResponseModel.Data != null) {
                            ...
                            if (verifyCodeResponseModel.Data.Status != null&&verifyCodeResponseModel.Data.Status.equals("Success")) {
                              ...
                              /*  SharedPrefUtils.setUserLoggedIn(VerifyOTPForgotPasswordActivity.this, true);
                                // SharedPrefUtils.setUserId(VerifyCodeActivity.this, String.valueOf(loginResponseModel.Data.userData.userID));
                               */ Intent intent = new Intent(VerifyOTPForgotPasswordActivity.this, ForgotPasswordActivity.class);
    ...
    public void getData(final int actionID) {
        ...
        switch (actionID) {
            case IApiEvent.REQUEST_FORGOT_PASSWORD_VERIFY_OTP:
                ...
                requestObject = RequestPostDataUtil.verifyOtpForgotPasswordApiRegParam(mDetails,mCode);
                request = requestObject.toString();
                RequestManager.addRequest(new GsonObjectRequest<VerifyCodeResponseModel>(IWebServices.REQUEST_FORGOT_PASSWORD_VERIFY_OTP, NetworkUtil.getHeaders(this),
        ...
        switch (view.getId()) {
            case R.id.bt_verify_code:
                ...
                if (isAllFieldsValid()) {
                    ...
                    getData(IApiEvent.REQUEST_FORGOT_PASSWORD_VERIFY_OTP);
                }
                break;
