...
public class ExitPollUnVotingDialogFragment extends DialogFragment implements IScreen, View.OnClickListener {

    private static final String TAG = ExitPollUnVotingDialogFragment.class.getSimpleName();
    ...
    public static ExitPollUnVotingDialogFragment newInstance(int mirrorId, int exitPollId) {
        ExitPollUnVotingDialogFragment fragment = new ExitPollUnVotingDialogFragment();
